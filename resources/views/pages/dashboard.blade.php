...
<body class="bg-spawn-bg text-gray-100 font-sans h-[100dvh] w-full overflow-hidden flex flex-col md:flex-row selection:bg-white selection:text-black">
    ...
    <aside class="w-64 bg-spawn-sidebar border-r border-white/5 flex-col justify-between hidden md:flex z-50 flex-shrink-0">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 bg-white/10 text-white rounded-lg transition-colors font-medium">
                <i class="ph ph-house text-xl"></i> Início
            </a>
            <a href="{{ route('catalogo') }}" class="flex items-center gap-3 px-3 py-2.5 text-spawn-muted hover:text-white hover:bg-white/5 rounded-lg transition-colors font-medium">
                <i class="ph ph-magnifying-glass text-xl"></i> Catálogo
            </a>
            <a href="{{ route('promocoes') }}" class="flex items-center gap-3 px-3 py-2.5 text-spawn-muted hover:text-white hover:bg-white/5 rounded-lg transition-colors font-medium">
            ...
            <a href="{{ route('biblioteca') }}" class="flex items-center gap-3 px-3 py-2.5 text-spawn-muted hover:text-white hover:bg-white/5 rounded-lg transition-colors font-medium">
                <i class="ph ph-books text-xl"></i> Biblioteca
            </a>
            <a href="{{ route('downloads') }}" class="flex items-center gap-3 px-3 py-2.5 text-spawn-muted hover:text-white hover:bg-white/5 rounded-lg transition-colors font-medium">
